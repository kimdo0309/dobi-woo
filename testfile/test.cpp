...
//차선 색깔 범위
Scalar lower_white = Scalar(100, 100, 200); //흰색 차선 (RGB)
...
void draw_line(Mat &img_line, vector<Vec4i> lines)
{
    ...
    extent of the lane(going from the result shown in raw - lines - example.mp4 to that shown in P1_example.mp4).

    Think about things like separating line segments by their
    slope((y2 - y1) / (x2 - x1)) to decide which segments are part of the left line vs.the right line.Then, you can average the position of each of
